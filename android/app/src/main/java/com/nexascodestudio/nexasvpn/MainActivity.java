package com.nexascodestudio.nexasvpn;
    ...
    private void startVPN() {
        try {
            ...
            if (vpnProfile.checkProfile(this) != de.blinkt.openvpn.R.string.no_error_found) {
                String errorMsg = getString(vpnProfile.checkProfile(this));
            ...
            Log.i(TAG, "VPN connection initiated successfully");
        } catch (RemoteException e) {
            Log.e(TAG, "RemoteException in startVPN: " + e.getMessage());
            setStage("disconnected");
            e.printStackTrace();
        } catch (Exception e) {
            Log.e(TAG, "Unexpected exception in startVPN: " + e.getMessage());
            setStage("disconnected");
            e.printStackTrace();
        }
    }
